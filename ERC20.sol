...
contract golcoin is ERC20 {
 
    // Constructor that mints the initial supply to the deployer's address tiptop
    constructor(uint256 initialSupply) ERC20("golcoin", "gol") {
    ...
    // Function to burn tokens from a specified address toiptop
    ...
    // Override the transferFrom function to allow spending tokens on behalf of an address tiptop
